...
export const hostUri = "http://127.0.0.1:10002/devstoreaccount1/";// process.env.STORAGE_HOST_URI_MDS; //`https://${account}.table.core.windows.net`
...
export const sasToken = "st=2020-06-19T06%3A45%3A04Z&se=2020-06-20T06%3A45%3A04Z&sp=rau&sv=2017-04-17&tn=episode&sig=oRhiFsqpVSIZPoXrlLT84NDEsoTVtnUMPM0h%2F9kDCng%3D";
